...
public:
	...
	static float TriangleAreaTimesTwo(const Vector3& b, const Vector3& c, const Vector3& m);

	static float TriangleAreaTimesTwo(const Vector2i& b, const Vector2i& c, const Vector2i& m);

...
float Triangle::TriangleAreaTimesTwo(const Vector3& b, const Vector3& c, const Vector3& m)
{
	Vector3 d1 = b - m;
	Vector3 d2 = c - m;
...
float Triangle::TriangleAreaTimesTwo(const Vector2i& b, const Vector2i& c, const Vector2i& m)
{
	Vector2i d = b;
	Vector2i e = c;
	Vector2i n = m;

	Vector2 d1 = reinterpret_cast<Vector2&>(d) - reinterpret_cast<Vector2&>(n);
	Vector2 d2 = reinterpret_cast<Vector2&>(e) - reinterpret_cast<Vector2&>(n);

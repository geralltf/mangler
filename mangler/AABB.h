...
public:
	...
	void Debug2D(RenderingContext renderer, ColourRGBA& boundsColour, ColourRGBA& centerColour);

	void Debug(RenderingContext renderer, ColourRGBA& boundsColour, ColourRGBA& centerColour);
};
